classdef GUI < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function ImportarBtnButtonPushed(app, event)
            ...
            if filename ~= 0
                ...
                app.globalList{n} = {filename, filepath};
            end
        end
        ...
        function PlayButtonPushed(app, event)
            clc
            for x=1:length(app.globalList)
                disp(app.globalList{x});
            end
        end
    end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.ListBox.Position = [491 146 200 200];
            app.ListBox.Value = {};
            ...
            app.ImportarBtn.Position = [541 93 100 22];
            ...
            app.PlayBtn.Position = [206 93 100 22];
            app.PlayBtn.Text = 'Play';

            % Create TabGroup
            app.TabGroup = uitabgroup(app.UIFigure);
            app.TabGroup.Position = [64 146 400 200];
            ...
            app.UIAxesSA.Position = [1 1 398 174];
            ...
            app.UIAxesEP.Position = [1 1 398 174];

            % Create TitleAudio
            app.TitleAudio = uilabel(app.UIFigure);
            app.TitleAudio.Position = [247 380 35 22];
